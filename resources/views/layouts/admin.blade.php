...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            {{-- <div class="navbar-brand"><a href="?">ISMART</a></div> --}}
            <div class="navbar-brand"><a href="{{route('home')}}" class="header__logo-link"><img src="{{asset('img/logo.png')}}" alt=""></a></div>
            <div class="nav-right ">
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    <li class="nav-link @if(strpos(url()->current(),'dashboard')) active @endif">
                    ...
                    <li class="nav-link @if(strpos(url()->current(),'/product/')) active @endif">
                    ...
                    <li class="nav-link @if(strpos(url()->current(),'/order/')) active @endif">
                    ...
                    <li class="nav-link @if(strpos(url()->current(),'/user/')) active @endif">
